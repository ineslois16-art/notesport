...
| `block_entries` | un bloc d'une journée : coché, répétitions réelles |

L'import accepte **deux formats** : les sauvegardes de l'application, et le
fichier JSON exporté par la page web « Suivi sportif de Val » (`web/suivi-sportif.html`
...
npm test           # tests du cœur métier (node:test)
```
